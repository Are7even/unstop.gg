...
(function(global, factory) {
  if (typeof define === "function" && define.amd) {
    define('AsGradient', ['exports', 'jquery', 'web/admin/plugins/colorpicker/jquery-asColor'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('jquery'), require('web/admin/plugins/colorpicker/jquery-asColor'));
  } else {
    var mod = {
      exports: {}
    };
